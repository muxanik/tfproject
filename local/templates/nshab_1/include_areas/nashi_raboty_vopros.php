<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"DISPLAY_FIELDS" => array(0=>"AUTHOR_NAME",1=>"AUTHOR_EMAIL",2=>"AUTHOR_PERSONAL_MOBILE",3=>"AUTHOR_MESSAGE",),
		"REQUIRED_FIELDS" => array(0=>"AUTHOR_NAME",1=>"AUTHOR_EMAIL",),
		"CUSTOM_FIELDS" => array(0=>"Скрытое поле@input@hidden@value=Значение поля по умолчанию",1=>"",),
		"ADMIN_EVENT_MESSAGE_ID" => array(0=>"28",),
		"USER_EVENT_MESSAGE_ID" => array(0=>"27",),
		"HIDE_FIELD_NAME" => "N",
		"TITLE_DISPLAY" => "Y",
		...
		"COUNT_INPUT_FILE" => "3",
		"FILE_DESCRIPTION" => array(0=>"Отправить фото своих дисков",1=>"Отправить фото своих дисков",2=>"Отправить фото своих дисков",3=>"",),
		"MAX_FILE_SIZE" => "10000",
