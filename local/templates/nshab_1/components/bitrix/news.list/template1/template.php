...
<?foreach($arResult["ITEMS"] as $arItem):?>
	...
	<tr id="<?=$this->GetEditAreaId($arItem['ID']);?>">
		<td colspan="4">
			<img src="<?=$arItem["PREVIEW_PICTURE"]["SRC"]?>" width="107" align="left" style="margin-right:10px; marker-offset:10px">
			<a href="<?=$arItem["DETAIL_PAGE_URL"]?>" class="qw">
				<b><?echo $arItem["DISPLAY_ACTIVE_FROM"]?> <?echo $arItem["NAME"]?></b>
			</a>
			<br>
			<br>
