	...
	<tbody>
		<?foreach($arResult["ITEMS"] as $cell => $arItem):?>
			...
			<?if($cell%2 == 0):?>
				<tr>
			<?endif;?>
				<td style="width: 47%;" valign="top" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
					...
					<p>
						<a href="<?=$arItem["DETAIL_PAGE_URL"]?>"><img style="padding-right: 15px;" src="<?=$arItem["PREVIEW_PICTURE"]["SRC"]?>" alt="" align="left" border="0" /></a>
						<?echo $arItem["PREVIEW_TEXT"];?> <a class="qw" href="<?=$arItem["DETAIL_PAGE_URL"]?>">Подробнее об услуге...</a>&nbsp;
					</p>
				</td>
				<td style="width: 6%;">&nbsp;</td>
			<?$cell++;
