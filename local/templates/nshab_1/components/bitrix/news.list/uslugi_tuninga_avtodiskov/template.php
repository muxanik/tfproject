...
<?foreach($arResult["ITEMS"] as $arItem):?>
	...
	<tr id="<?=$this->GetEditAreaId($arItem['ID']);?>">
	  	<td colspan="2" valign="top" align="left" class="text5">
		  	<img src="<?=$arItem["PREVIEW_PICTURE"]["SRC"]?>" border="0" style="padding-right: 15px;" align="left" />
		  	<a class="qw" href="<?echo $arItem["DETAIL_PAGE_URL"]?>"><?echo $arItem["NAME"]?></a><br />
		    <img src="<?=SITE_TEMPLATE_PATH?>/img/x.gif" border="0" width="1px" height="7px" /><br />
