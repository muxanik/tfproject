...
<?elseif(count($arResult["SEARCH"])>0):?>
	...
	<p><?if($arItem["ELEMENT"]["PICTURE"]):?><img src="<?=$arItem["ELEMENT"]["PICTURE"]["SRC"]?>"><?endif;?></p>
<?foreach($arResult["ELEMENT"]["PPICTURE"] as $key1 => $arImage):?>
	<p><img src="<?=$arItem["ELEMENT"]["PPICTURE"][$key1]["SRC"]?>">
<?endforeach;?>
		<?if (
