...
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"FILTER_NAME"	=>	$arParams["FILTER_NAME"] ? $arParams["FILTER_NAME"] : "arrFilterChildren",
...
$res = CIBlockSection::GetList(Array(), Array('CODE'=>$arResult["VARIABLES"]["SECTION_CODE"], "IBLOCK_ID"=> 40, "ACTIVE"=> "Y"));
