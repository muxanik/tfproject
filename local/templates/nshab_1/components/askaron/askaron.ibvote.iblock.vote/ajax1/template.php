...
if(!window.voteScript) window.voteScript =
{
	...
	do_vote: function(div, parent_id, arParams)
	{
		...
		var url = '<?=$component->GetPath();?>/component.php';
...
?>"></div></td>
	...
	<?if($arResult["PROPERTIES"]["vote_count"]["VALUE"]):?>
	<div style="text-align:center;" id="wait_vote_<?echo $arResult["ID"]?>"><?echo GetMessage("T_IBLOCK_VOTE_RESULTS", array("#VOTES#"=>$arResult["PROPERTIES"]["vote_count"]["VALUE"] , "#RATING#"=>$DISPLAY_VALUE))?></div>
	<?else:?>
		<div style="text-align:center;" id="wait_vote_<?echo $arResult["ID"]?>"><?echo GetMessage("T_IBLOCK_VOTE_NO_RESULTS")?></div>
	<?endif?>
</div>
