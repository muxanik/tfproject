...
<div class="col-3-div">
					<div class="api-file-string">
						...
						<div class="api-file-wrap">
							<span class="btn wwb" onclick="$('#<?=$tpl_class_name;?>_finput_<?= $i ?>').click()"><?= GetMessage('MSG_SELECT_FILE') ?></span>
		...
		<div class="api-submit">
			<input type="submit" name="submit" style="<?= $arParams['FORM_STYLE_SUBMIT'] ?>" class="<?=$arParams['FORM_SUBMIT_CLASS'];?> btn" id="<?=$arParams['FORM_SUBMIT_ID'];?>"  value="<?= $arResult['FORM_SUBMIT_VALUE'] ?>">
		</div>
