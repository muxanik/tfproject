...
<div class="col-3-div">
		...
		<div class="api-submit">
			<input type="submit" name="submit" style="<?= $arParams['FORM_STYLE_SUBMIT'] ?>" class="<?=$arParams['FORM_SUBMIT_CLASS'];?> btn1" id="<?=$arParams['FORM_SUBMIT_ID'];?>"  value="<?= $arResult['FORM_SUBMIT_VALUE'] ?>">
		</div>
