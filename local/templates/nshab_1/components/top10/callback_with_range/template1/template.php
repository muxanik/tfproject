...
<div class="callb">
<a style="border-bottom: 1px dashed;font-size: 16px;" class="top10_popup-with-form" href="#top10_feedback"><?=$arParams["BTN_CALLBACK"];?></a>
</div>
<div
	id="top10_feedback"
	...
	<div class="top10_left col-2_3-1-div">
		<?if($arParams["FOR_CALL"]):?>
			<strong><?=$arParams["FOR_CALL"];?></strong>
		<?endif;?>
		
		<div class="top10_phone"><a href="tel:+74959792001"><?=$arParams["PHONE"];?></a></div>
	...
	<div class="top10_right col-2_3-2-div">
		<?
